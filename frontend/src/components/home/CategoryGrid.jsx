...
const CategoryCard = ({ icon: Icon, title, onClick }) => (
  <button 
    ...
    className="group relative bg-surface-container border border-outline-variant rounded-2xl p-6 flex flex-col gap-3 
               ...
               /* Hiệu ứng nổi và zoom chính ở đây */
  ...
  >
    {/* Vòng tròn trang trí ẩn sau icon khi hover */}
...
const CategoryGrid = () => {
  ...
  const categories = [
    { 
      id: 1, title: 'Cổng Sắt Kỹ Nghệ', icon: DoorOpen, 
      desc: 'Gia công cổng sắt mỹ thuật với họa tiết hoa văn uốn lượn tinh xảo, sơn tĩnh điện cao cấp chống gỉ sét tuyệt đối.',
      features: ['Sắt đặc 100%', 'Sơn giả cổ', 'Bản lề tự động', 'Mối hàn thẩm mỹ']
    }, 
    { 
      id: 2, title: 'Cầu Thang & Lan Can', icon: LayoutGrid, 
      desc: 'Thiết kế lan can ban công, cầu thang xoắn ốc hiện đại cho biệt thự và nhà phố, tối ưu diện tích và sang trọng.',
      features: ['Tay vịn gỗ/sắt', 'Kính cường lực', 'Chống gỉ sét', 'Lắp đặt tận nơi']
    }, 
    { 
      id: 3, title: 'Hàng Rào Mỹ Thuật', icon: Layers, 
      desc: 'Hàng rào sắt bảo vệ kết hợp trang trí, đảm bảo an ninh nghiêm ngặt nhưng vẫn giữ được vẻ đẹp kiến trúc.',
      features: ['Mũi giáo an toàn', 'Liên kết hàn CO2', 'Độ bền trên 20 năm', 'Dễ dàng bảo trì']
    }, 
    { 
      id: 4, title: 'Kết Cấu Thép', icon: Construction, 
      desc: 'Gia công vì kèo, cột thép cho nhà xưởng và các công trình dân dụng quy mô lớn theo tiêu chuẩn kỹ thuật.',
      features: ['Thép SS400/A36', 'Cắt Plasma CNC', 'Bản vẽ kỹ thuật 3D', 'Chịu lực cao']
    },
    { 
      id: 5, title: 'Mái Che Tiền Chế', icon: Home, 
      desc: 'Hệ thống mái lấy sáng, mái Poly, mái tôn giả ngói cho sân thượng và nhà xe với khung sườn kiên cố.',
      features: ['Khung chịu lực tốt', 'Chống thấm tuyệt đối', 'Thi công nhanh', 'Cách nhiệt hiệu quả']
    }, 
    { 
      id: 6, title: 'Phụ Kiện Bản Mã', icon: Box, 
      desc: 'Cung cấp bản mã, bu lông, mặt bích cắt định hình theo yêu cầu kỹ thuật chính xác cho mọi công trình.',
      features: ['Cắt Laser theo yêu cầu', 'Mạ kẽm nhúng nóng', 'Giao hàng nhanh', 'Đa dạng độ dày']
    },
  ];
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <div className="w-full mt-2 bg-surface-container/50 p-6 rounded-2xl border border-outline-variant">
                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary mb-4 text-left">Tiêu chuẩn kỹ thuật KPM</h4>
                <div className="grid grid-cols-2 gap-3">
                  {activeCategory.features.map((feat, index) => (
                    <div key={index} className="flex items-center gap-2 text-[11px] font-bold text-on-surface-variant">
              ...
              <button className="w-full mt-4 py-5 bg-primary text-on-primary font-black rounded-2xl hover:bg-primary-container transition-all uppercase tracking-widest text-xs shadow-xl shadow-primary/30 active:scale-95">
