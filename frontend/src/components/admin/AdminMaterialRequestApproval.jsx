        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-48 gap-3 text-on-surface-variant/70">
            ...
            <span className="text-sm font-bold">
              Chưa có yêu cầu nhập vật tư nào.
            </span>
          </div>
        ) : (
                  ...
                  >
                    ...
                    <td className="p-4 max-w-xs">
                      <div className="space-y-1">
                        {req.materials ? (
                          <div className="bg-slate-100 px-2 py-1 rounded text-[11px] text-slate-700 truncate font-bold flex justify-between items-center">
                            <div className="flex flex-col items-end ml-2">
                              {/* Số lượng được yêu cầu */}
                              <span className="text-teal-700">
                                (Yêu cầu: x{req.requested_quantity})
                              </span>
                            </div>
                          </div>
                        ) : (
                        ...
                        {req.materials ? (
                          <div className="bg-slate-100 px-2 py-1 rounded text-[11px] text-slate-700 truncate font-bold flex justify-between items-center">
                            <span className="text-amber-600 text-[10px]">
                              (Tồn kho:{" "}
                              {req.materials.inventory?.[0]?.quantity || 0})
                            </span>
                          </div>
                        ) : (
                          <div className="text-slate-400 italic text-[11px]">
